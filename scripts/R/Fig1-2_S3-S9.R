...
for(dat in names(dataset)) {
  ...
  #-----------------------------------
  pca_file <- paste0(path_phenotypes, dat_name, "_PCs.csv")
  var_file <- paste0(path_phenotypes, dat_name, "_var.csv")
...
results_no_overall <- results[!names(results) %in% "lab_571_left_noflash"]
