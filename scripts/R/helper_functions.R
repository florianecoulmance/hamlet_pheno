...
plot_speciation_paper2 <- function(
  ...
  # ============================================================
  # 8. Panel B: Between sympatric species
  # ============================================================
