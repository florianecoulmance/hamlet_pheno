#!/usr/bin/python
# by: Floriane Coulmance: 05/03/2024
# code adapted from: 
# https://doi.org/10.1111/mec.17047
# usage: 
...
def modify_image(im_path, bo_mask, bl_mask, effect, path_fig, spe, loc):
    '''
    ...
    if (loc == "all"):
        if (spe == "pue"):
            file_list = [f for f in os.listdir(im_path) if (f.endswith('.png')) and ((str(re.findall(r'_(.+?)-',f))[-8:-5])=='pue')]
        elif (spe == "nig"):
            file_list = [f for f in os.listdir(im_path) if (f.endswith('.png')) and ((str(re.findall(r'_(.+?)-',f))[-8:-5])=='nig')]
        elif (spe == "uni"):
            file_list = [f for f in os.listdir(im_path) if (f.endswith('.png')) and ((str(re.findall(r'_(.+?)-',f))[-8:-5])=='uni')]
        elif (spe == "chl"):
            file_list = [f for f in os.listdir(im_path) if (f.endswith('.png')) and ((str(re.findall(r'_(.+?)-',f))[-8:-5])=='chl')]
        elif (spe == "ind"):
            file_list = [f for f in os.listdir(im_path) if (f.endswith('.png')) and ((str(re.findall(r'_(.+?)-',f))[-8:-5])=='ind')]
        elif (spe == "abe"):
            file_list = [f for f in os.listdir(im_path) if (f.endswith('.png')) and ((str(re.findall(r'_(.+?)-',f))[-8:-5])=='abe')]
        elif (spe == "all"):
            file_list = [f for f in os.listdir(im_path) if f.endswith('.png')]
        else:
            print("specify correct species")
    elif (loc == "boc"):
        file_list = [f for f in os.listdir(im_path) if (f.endswith('.png')) and ((str(re.findall(r'_(.+?)-',f))[-5:-2])=='boc')]
    elif (loc == "bel"):
        file_list = [f for f in os.listdir(im_path) if (f.endswith('.png')) and ((str(re.findall(r'_(.+?)-',f))[-5:-2])=='bel')]
    elif (loc == "tob"):
        file_list = [f for f in os.listdir(im_path) if (f.endswith('.png')) and ((str(re.findall(r'_(.+?)-',f))[-5:-2])=='tob')]
    elif (loc == "uvi"):
        file_list = [f for f in os.listdir(im_path) if (f.endswith('.png')) and ((str(re.findall(r'_(.+?)-',f))[-5:-2])=='uvi')]
    elif (loc == "por"):
        file_list = [f for f in os.listdir(im_path) if (f.endswith('.png')) and ((str(re.findall(r'_(.+?)-',f))[-5:-2])=='por')]
    elif (loc == "flo"):
        file_list = [f for f in os.listdir(im_path) if (f.endswith('.png')) and ((str(re.findall(r'_(.+?)-',f))[-5:-2])=='flo')]
    elif (loc == "ver"):
        file_list = [f for f in os.listdir(im_path) if (f.endswith('.png')) and ((str(re.findall(r'_(.+?)-',f))[-5:-2])=='ver')]
    else:
        print("specify correct locations")
...
def main():
    ...
    arr_modified, list_f = modify_image(path_images, bool_mask, mask_blur, color_space, path_figures, spec_name, geo_name)
